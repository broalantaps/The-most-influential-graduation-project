...
class ConverterConfig(PretrainedConfig):
    # This is a configuration class for MLP model
...
class Qwen3AgenticConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if compressor_config is None:
            compressor_config = {}
            logger.info("Compressor config is not provided, initializing with default values.")
